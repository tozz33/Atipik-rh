...
export const TARIF_INTER_LABEL = 'Tarif Inter'
export const TARIF_INTRA_LABEL = 'Tarif Intra'
export const TARIF_INTRA_TEXTE =
  "Se rapprocher du centre ATIPIK RH pour une étude personnalisée."
