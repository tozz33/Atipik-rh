...
export const professionnalisantesBySlug = {
  ...
  'renforcer-pratique-recrutement-inclusif': {
    ...
    price: '990',
    jsonLdDescription:
      "Formation pour prévenir les discriminations dans le recrutement (formation professionnelle). 11 heures en mixed learning.",
    sujetContact:
      'Demande formation — Prévenir les discriminations dans le recrutement (formation professionnelle)',
  },
  'renforcer-pratique-recrutement-diversite': {
