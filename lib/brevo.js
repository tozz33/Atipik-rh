...
const BREVO_ENTRY_LIST_ID = 30

/** Mappe le sujet du formulaire contact vers l'attribut Brevo FORMATION. */
export function mapSujetToFormation(sujet) {
  if (sujet === 'formation-cip') return 'CIP'
  if (sujet === 'formation-fpa') return 'FPA'
  return ''
}
