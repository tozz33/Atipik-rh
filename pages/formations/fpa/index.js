                          ...
                          <div className="p-6 border-t border-gray-200 animate-in slide-in-from-top-4 duration-300">
                            ...
                            <div className="mb-6">
                              ...
                              <div className="mt-6 text-center">
                                <Link
                                  href={`/formations/fpa/ccp${module.id}`}
                                  className="inline-flex items-center gap-2 px-5 py-2.5 rounded-full bg-[#013F63] hover:bg-[#012a4a] text-white font-semibold text-sm transition"
                                >
                                  Voir le CCP{module.id} FPA
